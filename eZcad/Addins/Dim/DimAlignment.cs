...
namespace eZcad.Addins.Dim
{
    ...
    public class DimAlignment : ICADExCommand
    {

        #region --- 命令设计

        /// <summary> 命令行命令名称，同时亦作为命令语句所对应的C#代码中的函数的名称 </summary>
        public const string CommandName = @"AlignDim";
        private const string CommandText = @"标注对齐";
        private const string CommandDescription = @"标注对象的对齐";
        ...
        {
            var s = new DimAlignment();
            return eZcadAddinManagerDebuger.DebugInAddinManager(s.AlignDim,
