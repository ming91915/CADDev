...
namespace eZcad.Addins.Geometry
{
    ...
    public class PolylineRemesh : ICADExCommand
    {

        #region --- 命令设计

        /// <summary> 命令行命令名称，同时亦作为命令语句所对应的C#代码中的函数的名称 </summary>
        public const string CommandName = @"RemeshPolyline";
        private const string CommandText = @"多段线疏密";
        private const string CommandDescription = @"对多段线的疏密进行重新设置";
        ...
        {
            var s = new PolylineRemesh();
            return eZcadAddinManagerDebuger.DebugInAddinManager(s.RemeshPolyline,
        ...
        /// <summary> 对多段线的疏密进行重新设置 </summary>
        private ExternalCmdResult RemeshPolyline(DocumentModifier docMdf, SelectionSet impliedSelection)
        {
