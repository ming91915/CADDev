...
namespace eZcad.Addins.Table
{
    ...
    [EcDescription("从文档中的表格排布的文字中提取出表格信息")]
    public class Ec_GetTableDataFromTable
: ICADExCommand
    {
            ...
            ref IList<ObjectId> elementSet)
        {
            ...
            return eZcadAddinManagerDebuger.DebugInAddinManager(tdg.GetTableFromText,
                impliedSelection, ref errorMessage, ref elementSet);
        }
    }

    [EcDescription("从文档中的多行或者多列文字中提取出表格信息")]
    public class Ec_GetTableDataFromVector : ICADExCommand
    {
        public ExternalCommandResult Execute(SelectionSet impliedSelection, ref string errorMessage,
            ref IList<ObjectId> elementSet)
        {
            var tdg = new TableDataGetter();
            return eZcadAddinManagerDebuger.DebugInAddinManager(tdg.GetVectorFromText,
                impliedSelection, ref errorMessage, ref elementSet);
        }
    }
