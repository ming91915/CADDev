...
[assembly: CommandClass(typeof(TextPlacer))]
...
namespace eZcad.SubgradeQuantityBackup.Cmds
{
    ...
    public class TextPlacer
    {
        ...
        [CommandMethod(eZConstants.eZGroupCommnad, "PlaceText", CommandFlags.UsePickSet)
        , DisplayName(@"放置防护"), Description("放置边坡防护的文字")]
        public void EcPlaceText()
        {
            DocumentModifier.ExecuteCommand(PlaceText);
        }

        /// <summary> 放置边坡防护的文字 </summary>
        public void PlaceText(DocumentModifier docMdf, SelectionSet impliedSelection)
        {
            _docMdf = docMdf;
            bool changeSingle;
            string newText;
