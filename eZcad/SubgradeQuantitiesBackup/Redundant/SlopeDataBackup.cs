...
{
    public class SlopeDataBackup
    {
        public static string AppName = "eZSubgradeQuantities";
        ...
        public double SlopeLengthBeThinFillTop { get; set; }
        ...
        public static SlopeDataBackup FromResultBuffer(ResultBuffer buff)
        {
            ...
            if (buffs.Length > 0 && buffs[0].Value.ToString() == AppName)
            {
                ...
                try
                {
                    ...
                    sl.InfoBlockHandle =Utils.ConvertToHandle(buffs[11].Value.ToString());
                    sl.CenterAxisHandle = Utils.ConvertToHandle(buffs[12].Value.ToString());
                    sl.SlopeLengthBeThinFillTop = (double)buffs[13].Value;
                }
                catch (Exception ex)
                {
                }
        ...
        public ResultBuffer ToResultBuffer()
        {
            ResultBuffer buff = new ResultBuffer
                ...
                new TypedValue((int)DxfCode.ExtendedDataReal, SlopeLengthBeThinFillTop)
                );
            return buff;
        }
        ...
        public object[] GetInfoVector()
        {
            ...
            return new object[]
            {
                ...
                SlopeLengthBelowWaterLevel, SlopeLengthBeThinFillTop, CenterElevation, NaturalSurfElevation,CenterElevation - NaturalSurfElevation
            };
        }

        public static object[,] GetAllInfo(IList<SlopeDataBackup> slopeDatas)
        {
