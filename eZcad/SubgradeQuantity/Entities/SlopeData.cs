    ...
    public class SlopeData
    {
        ...
        public static SlopeData FromEntity(Entity ent)
        {
            ...
            try
            {
                ...
                data.FillExcav = (Int16)buffs[2].Value == 1;
                data.OnLeft = (Int16)buffs[3].Value == 1;
        ...
        public void ToDict_Slopes(Transaction trans, DBDictionary container)
        {
            ...
            trans.AddNewlyCreatedDBObject(dbSlopes, true); // 如果在将字典对象添加到其容器字典之前，就用 AddNewlyCreatedDBObject ，则会出现报错：eNotInDatabase
            //
        ...
        public static List<ISlopeSeg> Combine(IList<Slope> slopes, IList<Platform> platforms)
        {
